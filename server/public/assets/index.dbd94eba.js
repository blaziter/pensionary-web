...
const Nc = () =>
  ...
  mN = () => {
    ...
    return (
      ...
      h.exports.useEffect(() => {
        b.get('http://localhost:8080/api/employee/all').then(async (s) => {
          i(await s.data);
        });
      }, []),
      w(A, {
...
const PN = () => {
  ...
  ON = () => {
    ...
    return (
      ...
      h.exports.useEffect(() => {
        b.get('http://localhost:8080/api/announcement/all').then(async (s) => {
          t(await s.data);
        });
      }, []),
      w(A, {
...
const Rv = (e) =>
  ...
  LN = () => {
    ...
    return (
      h.exports.useEffect(
        () => (
          b.get('http://localhost:8080/api/employee/all').then(async (i) => {
            t(await i.data);
          }),
          () => {}
        ),
